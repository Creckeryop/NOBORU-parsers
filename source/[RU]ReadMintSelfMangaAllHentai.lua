...
MintManga = ReadManga:new("MintManga", "https://mintmanga.live", "RUS", "MINTMANGARU", 2)
...
SelfManga = ReadManga:new("SelfManga", "https://selfmanga.ru", "RUS", "SELFMANGARU", 2)
...
AllHentai = ReadManga:new("AllHentai", "http://allhentai.ru", "RUS", "ALLHENTAIRU", 3)
